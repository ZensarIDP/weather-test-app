...
**Logs:**
- GKE: `kubectl logs -l app=my-weather-app -n default`
...
**Generated by Backstage IDP** - my-weather-app
...
- **GitHub Repository:** [View on GitHub](https://github.com/group:default/developers/my-weather-app)
